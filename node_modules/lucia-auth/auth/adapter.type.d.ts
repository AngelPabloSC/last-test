...
export type UserAdapter = Readonly<{
    ...
    updateUserAttributes: (userId: string, attributes: Record<string, any>) => Promise<UserSchema>;
    ...
    updateKeyPassword: (key: string, hashedPassword: string | null) => Promise<void>;
