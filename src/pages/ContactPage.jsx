...
export default function ContactPage() {
  return (
    <Box sx={{ width: '100%', minHeight: '100vh', bgcolor: '#0D0D0D' }}>
      <SEO 
        title="Contact Us | Nova Solutions Restoration | Free Estimates in Albany"
        description="Get in touch with Nova Solutions Restoration for a free inspection or estimate in Albany and the Capital Region. Trusted experts in roofing, siding, and gutters."
        keywords="contact Nova Solutions Restoration, roofing estimate Albany, siding inspection Capital Region, gutter repair quote NY"
      />
      <ContactHero />
      <InfoBar />
      <ServiceExploreMore />
