...
export default function LeaveReviewPage() {
  return (
    <Box sx={{ minHeight: '100vh', bgcolor: '#111111', pb: 10 }}>
      <SEO 
        title="Leave a Review | Nova Solutions Restoration | Share Your Feedback"
        description="Share your experience with Nova Solutions Restoration. Your feedback helps us improve and helps other homeowners in the Capital Region find the best roofing and siding services."
        keywords="leave a review Nova Solutions Restoration, roofing feedback Albany, siding contractor review Capital Region"
      />
      <Hero />
