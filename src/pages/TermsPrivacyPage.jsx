...
export default function TermsPrivacyPage() {
  ...
  return (
    <Box sx={{ minHeight: '100vh', bgcolor: '#0D0D0D', color: 'white', fontFamily: 'Inter, sans-serif' }}>
      <SEO 
        title="Privacy Policy and Terms | Nova Solutions Restoration"
        description="Read our full Privacy Policy and Terms & Conditions to understand how Nova Solutions collects, uses, and protects your data while delivering quality service in Capital Region."
        keywords="privacy policy Nova Solutions Restoration, terms and conditions roofing, data protection Albany"
      />
