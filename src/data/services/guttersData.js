...
export const GUTTERS = {
    seo: {
        title: "Gutter Installation & Repair Albany & Capital Region | Nova Solutions Restoration",
        description: "Top-rated gutter services in Albany. Nova Solutions Restoration provides gutter installation, seamless gutters, and debris protection. Free inspections!",
        keywords: "gutter installation Albany, seamless gutters Capital Region, gutter repair NY, debris protection, Nova Solutions Restoration",
    },
    hero: {
        image: IMGS.heroBg,
    ...
    sections: [
        {
            ...
            body: "At Nova Solution, we've been protecting Albany homes with professional gutter services for over 5 years. Our certified team delivers fast, reliable installation and repair — backed by warranties and a 5-star reputation.",
            certificates: true
        },
        {
...
export const GUTTER_GUARDS = {
    seo: {
        title: "Gutter Guards Albany | Leaf Protection Systems | Nova Solutions Restoration",
        description: "Say goodbye to clogged gutters! Nova Solutions Restoration installs premium gutter guards and leaf protection in Albany. Maintenance-free gutters for your home.",
        keywords: "gutter guards Albany, leaf protection Capital Region, clog free gutters, gutter covers NY, Nova Solutions Restoration",
    },
    hero: {
        image: IMGS.heroBg,
    ...
    sections: [
        {
            ...
            body: "Say goodbye to clogged gutters forever. Nova Solution installs industry-leading gutter guard systems that are designed specifically for Albany's climate — keeping your gutters clear through every season.",
            certificates: true
        },
        {
    ...
    sections: [
        {
            ...
            body: "Nova Solution is Albany's trusted gutter cap installer. Our certified team brings precision and quality to every project, backed by industry-leading warranties and a satisfaction guarantee.",
            certificates: true
        },
        {
    ...
    sections: [
        {
            ...
            body: "Trust Nova Solution for expert gutter cover installation in Albany. Our certified team ensures a perfect fit and flawless performance — protecting your home from water damage year-round.",
            certificates: true
        },
        {
    ...
    sections: [
        {
            ...
            body: "Nova Solution installs advanced gutter protection systems trusted by Albany homeowners. Our certified team ensures lasting performance through Albany's toughest seasons — rain, snow, and falling leaves.",
            certificates: true
        },
        {
    ...
    sections: [
        {
            ...
            body: "Nova Solution uses state-of-the-art micro-mesh leaf filter technology trusted by Albany homeowners. Our certified installers ensure every gutter is protected — keeping debris out and water flowing freely.",
            certificates: true
        },
        {
    ...
    sections: [
        {
            ...
            body: "Nova Solution is Albany's go-to team for professional leaf guard installation. Our certified experts deliver durable, weatherproof systems designed to protect your gutters through every season — with no maintenance required.",
            certificates: true
        },
        {
    ...
    sections: [
        {
            ...
            body: "Nova Solution is Albany's trusted gutter repair company. With 5+ years of experience, our certified team rapidly diagnoses and fixes gutter problems — protecting your home from costly water damage.",
            certificates: true
        },
        {
    ...
    sections: [
        {
            ...
            body: "When your gutters are beyond repair, Nova Solution delivers seamless gutter replacement that protects your home for decades. Our certified team handles every detail — from removal to installation — with precision and care.",
            certificates: true
        },
        {
