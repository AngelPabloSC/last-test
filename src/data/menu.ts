export const headerMenu = [
    ...
    { name: 'Roofing', link: '/Roofing', showArrow: true,
        children: [
     ...
     { name: 'Roof Repair', link: '/Roofing-Repair', showArrow: true,
        children: [
     ...
     { name: 'Siding', link: '/Siding ', showArrow: true,
        children: [
    ...
    //  { name: 'windows', link: '/roofing', showArrow: true,
    //     children: [
    //         { name: 'Roofing', link: '/roofing' },
    //         { name: 'Roff Installation', link: '/residential-roofing' },
    //         { name: 'Asphalt shingle', link: '/theme-info#testimonials' },
    //         { name: 'insurance Claims', link: '/theme-info#faqs' },
    //         { name: 'Metal Roofing', link: '/theme-info#faqs' },
    //         { name: 'Commercial', link: '/theme-info#faqs' },
         
    //     ]
    //  },
     { name: 'Gutters', link: '/Gutters', showArrow: true,
        children: [
            { name: 'Gutters', link: '/Gutters' },
            { name: 'Gutter Guards', link: '/Gutters/Gutter-Guards' ,
                children: [
