...
export default function AdminGalleryDetailDialog({ open, onClose, project }) {
    ...
    >
      <Box sx={{ position: 'relative' }}>
        ...
        <Box sx={{ position: 'relative', height: 300, overflow: 'hidden' }}>
          <Box
            component="img"
            src={project.img || (project.images && project.images[0]?.url) || 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=1440&q=80'}
