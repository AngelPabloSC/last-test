...
import GlobalSuccessDialog from '@/components/dialogs/GlobalSuccessDialog';
...
export default function ContactForm() {
  ...
  return (
    <>
      <GlobalSuccessDialog open={dialogSuccess} onClose={resetStatus} />
      <GlobalErrorDialog   open={dialogError}   onClose={resetStatus} onRetry={handleSubmit(onSubmit)} />
